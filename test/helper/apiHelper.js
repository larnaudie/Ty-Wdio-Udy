...
var supertest_1 = require("supertest"); // para usar 'esModuleInterop'
...
function GET() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)("https://reqres.in/").get("api/users?page=2")];
                case 1:
                    resultado = _a.sent();
                    console.log("<<<<<<<<<<<<<<<<<<< Reusltado: ".concat(resultado));
                    return [2 /*return*/];
            }
        });
    });
